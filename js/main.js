...
const sigils = document.querySelectorAll('.sigilContainer'),
  ...
  forward = document.querySelector ('.fastForward'),
...
vidPlayer.play();
  ...
  imageBanner.style.right = (this.dataset.offset * 600) + "px";
...
function fastForward(){
  vidPlayer.currentTime = vidPlayer.currentTime + 25;
}
function rwd() {
...
rewind.addEventListener('click',rwd);
